...
| **Configuration** | View account-level settings, enabled Extensions, and fee configuration |
| **Status & alerts** | Link to the Rhino status page; incident history |
...
The Console requires an account. New accounts are provisioned by the Rhino team. To request access, contact your account representative or use the "Talk to the team" button in these docs.
