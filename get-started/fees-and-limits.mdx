...
Default deposit limits per transaction are:

- **Minimum:** $10 USD equivalent
- **Maximum:** $100,000 USD equivalent (larger limits available on request up to $10M USD equivalent)

Deposits below the minimum or above the maximum are not processed. With the Advanced Fee & Limit Management extension, minimum and maximum limits can be adjusted by agreement.
