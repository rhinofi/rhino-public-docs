...
Rhino.fi provides 1:1 support when the rate between USDT and USDC sits within an agreed band, in an agreed band above this the client will pay the additional difference, where the rate sits at anything above these agreed bands, then the rate that the customers receive reverts to the market rate.
