...
Rhino.fi provides 1:1 support when the rate between USDT and USDC is up to 3bps (the [Rhino.fi](http://Rhino.fi) guardrail), it is then possible for client's who have the Advanced Fee and Limit Management extension to set an additional Client guardrail and continue providing a 1:1 experience for customers between the [Rhino.fi](http://Rhino.fi) and Client guardrail. Thereafter the activity will return to market rate.
