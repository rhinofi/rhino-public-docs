...
<Steps>
  ...
  <Step title="Fetching Smart Deposit Address configs">
    Retrieve supported [chains](https://docs.rhino.fi/api-reference/bridge/configs/configs-chains-&-tokens) and [tokens](https://docs.rhino.fi/api-reference/sda/depositaddresses/get-supported-tokens-between-a-deposit-chain-and-a-destination-chain).
  </Step>
  <Step title="Generate address">
    Call our API to [generate a Smart Deposit Address](https://docs.rhino.fi/api-reference/sda/depositaddresses/create-new-deposit-address) which will allow funds to be received across multiple chains. We strongly recommend generating an SDA on all available EVM chains to ensure that funds accidentally sent by customers to the wrong chain and automatically detected. More best practices can be found [here.](https://learn.rhino.fi/articles/9715155695-what-are-best-practices-when-operating-sdas) 
  </Step>
...
For the exact response format and more details, see the [**API Reference**](https://docs.rhino.fi/api-reference/sda/depositaddresses/get-supported-tokens-between-a-deposit-chain-and-a-destination-chain).
...
For the exact response format and more details, see the [**API Reference**](https://docs.rhino.fi/api-reference/sda/depositaddresses/create-new-deposit-address).
...
For the exact response format and more details, see the [**API Reference**](https://docs.rhino.fi/api-reference/sda/depositaddresses/get-deposit-address-history).
...
For the exact response format and more details, see the [**API Reference**](https://docs.rhino.fi/api-reference/sda/depositaddresses/search-deposit-addresses-by-different-fields).