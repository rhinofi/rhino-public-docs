...
For the exact response format and more details, see the [API Reference](/api-reference/bridge/configs/obtain-token-and-chain-details-for-swapping-andor-bridging-activity).
...
For the exact request / response format and more details, see the [API Reference](/api-reference/bridge/quote/generate-a-bridgebridge+swap-quote).
...
For the exact request / response format and more details, see the [API Reference](/api-reference/bridge/quote/commit-an-already-generated-quote).
...
We recommend using the [SDK](https://docs.rhino.fi/sdk/bridge-functions/bridge) for a simpler bridging experience.

For a detailed breakdown of API endpoints and parameters, check the [API Reference](/api-reference).

Further examples can be found within the [bridge-examples README](https://github.com/rhinofi/bridge-examples).
