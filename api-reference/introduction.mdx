...
<Note>
  If you're looking for a quick start guide, check out the [Quick Start](/get-started/quickstart) guide.
</Note>
...
This method is recommended if you're interested in displaying historical transactions to users but an EVM wallet is required.
