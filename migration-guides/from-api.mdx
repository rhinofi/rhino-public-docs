---
title: "From API to SDK"
"og:title": "From API to SDK | Migration Guide SDK | Rhino.fi"
...
```typescript
// Manual API call
const result = await fetch('https://api.rhino.fi/bridge/quote/bridge-swap/user', {
  method: 'POST',
  headers: {
...
// SDK replacement
const result = rhinoSdk.api.bridge.getSwapUserQuote(quoteArgs)
```
