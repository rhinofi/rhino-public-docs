...
- The generated quote, including the expiration date that the quote but me commited by - as the  `expiresAt`param.
- Information about the currently available and required token allowance
